                        ...
                        <div class="card-content">
                            ...
                            <div class="card-body card-feature">
                                ...
                                <div class="text-center">
                                    <h2>Rp. 1.500.000</h2>
                                    <h4 style="text-decoration: line-through red; font-size: 16px; color: rgba(0,0,0,.8)">Rp. 3.000.000</h4>
                                </div>
                            </div>
                    ...
                    <div class="card mb-4">
                        <div class="card-content">
                            ...
                            <div class="card-body card-feature">
                                ...
                                <div class="text-center">
                                    <h2>Rp. 2.250.000</h2>
                                    <h4 style="text-decoration: line-through red; font-size: 16px; color: rgba(0,0,0,.8)">Rp. 4.500.000</h4>
                                </div>
                            </div>
                            <div class="card-footer">
                    ...
                    <div class="card mb-4">
                        <div class="card-content">
                            ...
                            <div class="card-body card-feature">
                                ...
                                <div class="text-center">
                                    <h2>Rp. 3.000.000</h2>
                                    <h4 style="text-decoration: line-through red; font-size: 16px; color: rgba(0,0,0,.8)">Rp. 6.000.000</h4>
                                </div>
                            </div>
                            <div class="card-footer">
