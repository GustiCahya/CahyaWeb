        ...
        <!--website bisnis-->
        <section class="container-fluid website-service" id="service">
                        ...
                        <div class="card-content">
                            ...
                            <div class="card-body card-feature">
                                ...
                                <div class="text-center">
                                    <h2>Rp. 2.500.000</h2>
                                    <h4 style="text-decoration: line-through red; font-size: 16px; color: rgba(0,0,0,.8)">Rp. 5.000.000</h4>
                                </div>
                            </div>
                    ...
                    <div class="card mb-4">
                        <div class="card-content">
                            ...
                            <div class="card-body card-feature">
                                ...
                                <div class="text-center">
                                    <h2>Rp. 4.000.000</h2>
                                    <h4 style="text-decoration: line-through red; font-size: 16px; color: rgba(0,0,0,.8)">Rp. 8.000.000</h4>
                                </div>
                            </div>
                            <div class="card-footer">
                    ...
                    <div class="card mb-4">
                        <div class="card-content">
                            ...
                            <div class="card-body card-feature">
                                ...
                                <div class="text-center">
                                    <h2>Rp. 5.000.000</h2>
                                    <h4 style="text-decoration: line-through red; font-size: 16px; color: rgba(0,0,0,.8)">Rp. 10.000.000</h4>
                                </div>
                            </div>
                            <div class="card-footer">
        ...
        <section class="container-fluid website-bisnis-contoh">
            <div class="row text-center justify-content-center">
                <h1 class="display-4 title-border mt-5 mb-2" style="font-size: 30px; font-weight: 500">Contoh Website Bisnis</h1>
            </div>
            <div class="row text-center justify-content-center">
            ...
            <div class="row justify-content-around contoh-web" style="margin-bottom: 48px">
                ...
                <a class="col-lg-5 border" target="_blank" href="https://bisnis2.cahyaweb.com">
                    <div>
