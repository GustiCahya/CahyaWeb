       <!--website e-commerce-->
                        ...
                        <div class="card-content">
                            ...
                            <div class="card-body card-feature">
                                ...
                                <div class="text-center">
                                    <h2>Rp. 3.500.000</h2>
                                    <h4 style="text-decoration: line-through red; font-size: 16px; color: rgba(0,0,0,.8)">Rp. 7.000.000</h4>
                                </div>
                            </div>
                    ...
                    <div class="card mb-4">
                        <div class="card-content">
                            ...
                            <div class="card-body card-feature">
                                ...
                                <div class="text-center">
                                    <h2>Rp. 5.500.000</h2>
                                    <h4 style="text-decoration: line-through red; font-size: 16px; color: rgba(0,0,0,.8)">Rp. 11.000.000</h4>
                                </div>
                            </div>
                            <div class="card-footer">
                    ...
                    <div class="card mb-4">
                        <div class="card-content">
                            ...
                            <div class="card-body card-feature">
                                ...
                                <div class="text-center">
                                    <h2>Rp. 12.500.000</h2>
                                    <h4 style="text-decoration: line-through red; font-size: 16px; color: rgba(0,0,0,.8)">Rp. 25.000.000</h4>
                                </div>
                            </div>
                            <div class="card-footer">
        ...
        <section class="container-fluid website-ecommerce-contoh">
            <div class="row text-center justify-content-center">
                <h1 class="display-4 title-border mt-5 mb-2" style="font-size: 30px; font-weight: 500">Contoh Website E-Commerce</h1>
            </div>
            <div class="row text-center justify-content-center">
